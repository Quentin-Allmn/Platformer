class SceneGameOver extends Phaser.Scene{
    ...
    create() {
        ...
        this.add.text(380,320,"Victory !",{ fontFamily: 'Asian', color: '#FFC100', fontSize: '100px' });

        this.add.text(320,420, "you managed to save your village !",{ fontFamily: 'Asian', color: '#FFC100', fontSize: '60px' });
